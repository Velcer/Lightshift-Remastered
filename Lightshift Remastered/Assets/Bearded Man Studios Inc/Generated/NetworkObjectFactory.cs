			...
			MainThreadManager.Run(() =>
			{
				switch (identity)
				{
					...
					case CubeForgeGameNetworkObject.IDENTITY:
						...
						break;
					case EntityNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new EntityNetworkObject(networker, id, frame);
						break;
					...
					case GameManagerNetworkObject.IDENTITY:
						...
						break;
					case InventoryNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new InventoryNetworkObject(networker, id, frame);
						break;
					...
					case PlayerNetworkObject.IDENTITY:
						...
						break;
					case SyncTransformNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new SyncTransformNetworkObject(networker, id, frame);
						break;
